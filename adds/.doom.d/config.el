...
(setq user-full-name "c0deWanted"
      user-mail-address "postwanted@protonmail.com")
...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Mononoki Nerd Font Mono" :size 19 :weight 'regular)
